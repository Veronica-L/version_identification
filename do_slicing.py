...
class Test():
    def __init__(self, filename, project, cfg, function_cfg, main_func_addr, target_addrs, path_address):
        self._p = project
        ...
        self._path_address = path_address
        self.avoid_list = []
    ...
    def slice(self):
        ...
        path_address = self._path_address
